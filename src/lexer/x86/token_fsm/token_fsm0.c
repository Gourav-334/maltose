...
void token_fsm0(char *str, unsigned short int start, signed short int *state)
{
	switch(*state)
	{
		...
		case 4:
			if (*(str+start)=='0' || *(str+start)=='1' || *(str+start)=='2' || *(str+start)=='3' || *(str+start)=='4' || *(str+start)=='5' || *(str+start)=='6' || *(str+start)=='7' || *(str+start)=='8' || *(str+start)=='9' || *(str+start)=='a' || *(str+start)=='A' || *(str+start)=='b' || *(str+start)=='B' || *(str+start)=='c' || *(str+start)=='C' || *(str+start)=='d' || *(str+start)=='D' || *(str+start)=='e' || *(str+start)=='E' || *(str+start)=='f' || *(str+start)=='F') {*state = 12;}
			else {*state = -4;}
