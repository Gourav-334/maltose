...
bool token_recog(char *str, int point, int row, int column)
{
	...
	else if (!match_ins_case(str, " ", false, "dev")) {insert_node(&token, " ", true, "dev"); insert_node(&categ, "delimiter", true, "dev"); insert_node(&sub_categ, "separator", true, "dev"); insert_node(&type, "whitespace", true, "dev"); return true;}
	...
	else if (!match_ins_case(str, "\n", false, "dev")) {insert_node(&token, "\n", true, "dev"); insert_node(&categ, "delimiter", true, "dev"); insert_node(&sub_categ, "terminator", true, "dev"); insert_node(&type, "endline", true, "dev"); return true;}
	else if (!match_ins_case(str, "\t", false, "dev")) {insert_node(&token, "\t", true, "dev"); insert_node(&categ, "delimiter", true, "dev"); insert_node(&sub_categ, "skipper", true, "dev"); insert_node(&type, "tabspace", true, "dev"); return true;}
	else if (!match_ins_case(str, "\'", false, "dev")) {insert_node(&token, "\'", true, "dev"); insert_node(&categ, "stringizer", true, "dev"); insert_node(&sub_categ, "inverted_comma", true, "dev"); insert_node(&type, "single", true, "dev"); return true;}
	else if (!match_ins_case(str, "\"", false, "dev")) {insert_node(&token, "\"", true, "dev"); insert_node(&categ, "stringizer", true, "dev"); insert_node(&sub_categ, "inverted_comma", true, "dev"); insert_node(&type, "double", true, "dev"); return true;}
